package com.zekaimedia.batterysaverpro.service;
...
import com.zekaimedia.batterysaverpro.notification.NotificationBattery;
import com.zekaimedia.batterysaverpro.Alarm.AlarmUtils;
import com.zekaimedia.batterysaverpro.Receiver.BatteryStatusReceiver;
import com.zekaimedia.batterysaverpro.Utilsb.SharePreferenceUtils;
import com.zekaimedia.batterysaverpro.Utilsb.Utils;
import com.zekaimedia.batterysaverpro.task.TaskScreenOff;
...
//            }
        ...
        if (SharePreferenceUtils.getInstance(this).getNotification()) {
            ...
            if (Build.VERSION.SDK_INT >= 26) {
                NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(this, Utils.notification_channel_id);
