package com.tforlive.batterysaverpro.task;
...
import com.tforlive.batterysaverpro.model.TaskInfo;
...
public class TaskWifiBooster extends AsyncTask<Void, TaskInfo, ArrayList<TaskInfo>> {
    ...
    public TaskWifiBooster(Context context, TextView titleApp, OnTaskListListener onTaskListListener) {
        mContext = context;
